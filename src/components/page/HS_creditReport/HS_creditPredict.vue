...
<el-button  type="primary" @click="reset">重置</el-button>
        ...
        <!-- <el-dialog :visible.sync="showDialogVisible" width="60%">
            ...
            <el-row style="margin-top:20px;font-weight:bold;font-size: 16px;
                    line-height: 30px;
                    font-weight: bold;">
                <el-card>
                    <el-row>
                    ...
                    <el-row style="margin-top:20px;">
                        ...
                        <el-col :span="12" style="text-align:center">
                            <b style="color:red">{{reportList.loans_count}}</b>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.loans_settle_count}}</b>
                        </el-col>
                    </el-row> 
                    ...
                    <el-row>
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.loans_overdue_count}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.loans_org_count}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.consfin_org_count}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.loans_cash_count}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.latest_one_month}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.latest_three_month }}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.latest_six_month}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.history_suc_fee}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.history_fail_fee}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.latest_one_month_suc}}</b>
                        </el-col>
                    </el-row>                                                                                                                                                                                                                            
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.latest_one_month_fail}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.loans_long_time}}</b>
                        </el-col>
                    </el-row> 
                    <el-row>
                        <el-col :span="8">
                        ...
                        <el-col :span="12" style="text-align:center">
                           <b style="color:red">{{reportList.loans_latest_time}}</b>
                        </el-col>
                    </el-row>                                                             
                </el-card>
            </el-row>                                 
        </el-dialog>   -->
        <el-dialog  width="60%" :visible.sync="showDialogVisible" >
                ...
                <el-card >
                    <div class="xy_card">
                        <div>
                            <dl>
                                <dt>客户基本资料</dt>
                                <dd>姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{userInfo.realname}}</span></dd>
                                <dd>手机号：&nbsp;&nbsp;&nbsp;<span>{{userInfo.phonenume}}</span></dd>
                                <dd>身份证号：<span>{{userInfo.idcard}}</span></dd>
                            </dl>
                        </div>
                        <div>
                                <div class="progress-text">
    ...
    handleReport(index, row) {
      ...
      httpGetxinyanreport(id)
        .then(res => {
          let data = res.data;
          if (data.code == 200) {
            this.reportList = JSON.parse(data.data.data).data.result_detail;
